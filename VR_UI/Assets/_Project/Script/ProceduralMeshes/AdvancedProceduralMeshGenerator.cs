...
public class AdvancedProceduralMeshGenerator : MonoBehaviour
{
    private void OnEnable()
    {
        ...
        vertexAttributes[0] = new VertexAttributeDescriptor(dimension: 3); // set position 
        vertexAttributes[1] = new VertexAttributeDescriptor(VertexAttribute.Normal, dimension: 3, stream: 1); // normal
        vertexAttributes[2] = new VertexAttributeDescriptor(VertexAttribute.Tangent, dimension: 4, stream: 2); // tangents
        vertexAttributes[3] = new VertexAttributeDescriptor(VertexAttribute.TexCoord0, dimension: 2, stream: 3); // texture coordinate
        ...
        var mesh = new Mesh { bounds = bounds, name = "new Procedural Mesh" };
